    ...
    public class s_sock
    {
        ...
        public void RecvThread(object dataa)
        {
            ...
            while (true)
            {
                ...
                {
                    string name = (string)Data.Sock_hashTable[socket];
                    //if (!Data.Game_start)
                    //{
                        Data.user_Delete(name);
                        Data.Sock_hashTable.Remove(socket);
                        Data.Sock_table.Remove(name);
                    //}
                    Console.WriteLine("닉네임 : " + name + "  퇴장");
        ...
        private bool recvmessage(Socket client)
        {
            ...
            if (data != null)
            {
                ...
                Control.MsgRecv(client,Encoding.Default.GetString(data));
                return true;
            }
            else
            {
